...
public class SimpleJCublas {
    ...
    static {
        ...
        log.info("Loading jcublas from " + GlobalParameters.nd4jResourceDir+name);
        ...
        try {
            ...
            IOUtils.copy(util.IOUtils.getInputStream(GlobalParameters.nd4jResourceDir+name),bos);
            bos.flush();
            bos.close();
    ...
    private static String findWritableLibDir() {
    	return GlobalParameters.nd4jLibraryDir;
