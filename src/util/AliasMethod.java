...
public final class AliasMethod {
    ...
    public AliasMethod(List<Double> probabilities, Random random) {
    	probabilities = normList(probabilities);
    ...
    public LinkedList<Double> normList(List<Double> toNorm){
    	LinkedList<Double> normed = new LinkedList<Double>();
    	double sum = 0;
    	for(Double d : toNorm){
    		sum+=d;
    	}
    ...
    public static void main(String[] args){
    	...
    	list.add(3.0);
    	list.add(4.0);
    	AliasMethod m = new AliasMethod(list);
