...
public class MorfessorExtractorSuffix implements FeatureExtractor{
	...
	public MorfessorExtractorSuffix(String vocabFile) {
		super();
	...
	public String extract(String word) {
		if(!wordToSuffix.containsKey(word)){
			return "noprefix";
		}
		return wordToSuffix.get(word);
	}
}
