...
public class MorfessorExtractorPrefix implements FeatureExtractor{
	...
	public MorfessorExtractorPrefix(String vocabFile) {
		super();
	...
	public String extract(String word) {
		if(!wordToPrefix.containsKey(word)){
			return "noprefix";
		}
		return wordToPrefix.get(word);
	}
}
